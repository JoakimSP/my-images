...
<footer className="p-4 bg-white sm:p-6 bg-darkTheme">
    <div className="md:flex md:justify-between">
        <div className="mb-6 md:mb-0">
            <a href="#" className="flex items-center">
                <img src="myimages-logo-white-2.svg" className="h-8 mr-3" alt="FlowBite Logo" />
    ...
    <div className="sm:flex sm:items-center sm:justify-between">
        <span className="text-sm text-gray-500 sm:text-center dark:text-gray-400">© 2023 <a href="#" className="hover:underline">SProduction™</a>. All Rights Reserved.
        </span>
