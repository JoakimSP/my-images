...
export default function SearchBlock() {
  ...
  function showDropDown() {
    setToggleclassName(prevState => true)
  ...
  return (
    <div className="flex place-items-center justify-center h-96 bg-[length:1920px_600px] bg-no-repeat px-7 sm:w-screen" style={{ backgroundImage: `url(${BgImage.src})` }} >
      <div className="flex">
        ...
        <div id="dropdown" className={`z-10 absolute top-72 ${toggleClassName ? 'block' : 'hidden'} bg-white divide-y divide-gray-100 rounded-lg shadow w-44 dark:bg-gray-700`}>
