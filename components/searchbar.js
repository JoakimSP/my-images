...
export default function Searchbar() {
    ...
    return (
        <div className="flex place-items-center justify-center h-96 bg-[length:1920px_600px] bg-no-repeat px-7 sm:w-screen bg-[url('/content/images/0B041BE3-0CE9-48ED-9292-2754316E0B01.JPG')]">
